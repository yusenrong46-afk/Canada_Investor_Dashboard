...
// Teal ramp endpoints (Tailwind teal-100 -> teal-900) so cell shading matches the app's brand palette.
const rampLow: [number, number, number] = [204, 251, 241];
const rampHigh: [number, number, number] = [19, 78, 74];
              ...
              {ready.cells.map((cell) => {
                ...
                return (
                  <Polygon
                    ...
                    pathOptions={{ color: "#0f766e", weight: 1, opacity: 0.5, fillColor: color, fillOpacity: 0.55 }}
