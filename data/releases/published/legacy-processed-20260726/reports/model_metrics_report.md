...
Generated from approved pickle artifacts. Column names follow the split stored in each bundle. A random split is never labeled temporal. The Vancouver section below is the historical random 80/20 listing-price evaluation. It was not recomputed in this milestone.
...
| Segment | Model | Random-split MAE | Random-split MAPE | Random-split R2 | N | Random MAE | Random MAPE |
|---|---|---:|---:|---:|---:|---:|---:|
