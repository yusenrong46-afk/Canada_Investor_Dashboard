...
def test_fixed_seed_conformal_coverage_within_five_points_of_target() -> None:
    actual, predicted = _synthetic_holdout(2000, seed=42)

    calibration = calibrate_split_conformal(actual, predicted, alpha=0.2, random_state=42)
    ...
    assert 0.75 <= calibration.empirical_coverage <= 0.85
